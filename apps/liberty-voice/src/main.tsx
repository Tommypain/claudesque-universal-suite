...
function VoiceAppStub() {
  return (
    <div style={{ display: "flex", height: "100vh", alignItems: "center", justifyContent: "center", background: "#f3f3ee", fontFamily: "Segoe UI, sans-serif", flexDirection: "column", gap: "12px" }}>
      ...
      <h1 style={{ fontSize: "20px", fontWeight: "bold", color: "#1a1a1a" }}>Liberty Voice</h1>
      <p style={{ fontSize: "13px", color: "#666" }}>Voice recognition and automated dictation engine stub.</p>
      <button 
